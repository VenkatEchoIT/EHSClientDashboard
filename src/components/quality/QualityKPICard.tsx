import type { QualityKPICardData, QualityKPITone } from "../../types/qualityPerformance";
import { Sparkline } from "./Sparkline";
import { TrendTag } from "./TrendTag";

interface QualityKPICardProps {
  data: QualityKPICardData;
}

const sparklineColorByTone: Record<QualityKPITone, string> = {
  accent: "#e8631f",
  amber: "#eba91f",
  success: "#1f9254",
  info: "#3f6fd1",
...
const barColorByTone: Record<QualityKPITone, string> = {
...
function DonutVisual({ value, tone }: { value: number; tone: QualityKPITone }) {
  const radius = 15.5;
